...
export const userSchema=yup.object({
    ...
    password_confirmation: yup.string().oneOf([yup.ref("password")],"Password should match"),
    contact: yup
    .string()
    ...
    profile:yup.mixed().test("ProfileType","Profile must be an image",(file:any)=>{
    const isValid=file?.type==="image/jpeg" || file?.type==="image/jpg" || file?.type==="image/webp" || file?.type==="image/png" 
    return isValid
